...
import { cn, cssVar, getComponentTheme, getAnimation } from '@/lib/theme/utils';
...
export function VoteSystem({ cards, projectId }: VoteSystemProps) {
  ...
  const alertTheme = getComponentTheme('alert');
  const loadingTheme = getComponentTheme('loading');
