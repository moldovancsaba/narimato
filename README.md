...
![Version](https://img.shields.io/badge/version-6.14.0-blue.svg)
...
**Current Version:** 6.14.0 *(ESLint CLI migration + local fieldnames plugin; dev CSP allows Next.js HMR while production CSP remains strict)*
