...
import { Modal, Group, Text as Text2 } from "@mantine/core";

// src/SemanticButton.tsx
import { useState, useEffect } from "react";
import { Button } from "@mantine/core";
import { useGdsTranslation } from "@gds/theme";
import { IconCheck as IconCheck2, IconX as IconX2 } from "@tabler/icons-react";
...
function SemanticButton({ action, loading, feedbackState, feedbackText, ...props }) {
  ...
  if (internalFeedback === "success") {
    const defaultFeedback = "feedback" in config && config.feedback ? config.feedback : { icon: IconCheck2, color: "teal", messageId: "gds.feedback.saved" };
  ...
  return /* @__PURE__ */ jsx3(
    Button,
    {
      leftSection: /* @__PURE__ */ jsx3(Icon, { size: "1rem" }),
      loading,
      color,
      ...props,
      children: label
...
function ConfirmDialog({
  ...
  return /* @__PURE__ */ jsxs2(Modal, { opened, onClose, title, centered: true, trapFocus: true, children: [
    /* @__PURE__ */ jsx4(Text2, { size: "sm", mb: "xl", children }),
    /* @__PURE__ */ jsxs2(Group, { justify: "flex-end", children: [
      /* @__PURE__ */ jsx4(SemanticButton, { action: cancelAction, variant: "default", onClick: onClose, disabled: loading }),
      /* @__PURE__ */ jsx4(SemanticButton, { action: confirmAction, color: isDanger ? "red" : "violet", onClick: onConfirm, loading })
    ] })
  ] });
}
...
function ThemeToggle({ size = "md" }) {
  ...
  return /* @__PURE__ */ jsx5(
    ActionIcon,
    {
      ...
      children: isDark ? /* @__PURE__ */ jsx5(GdsIcons.Sun, { size: "1.2rem" }) : /* @__PURE__ */ jsx5(GdsIcons.Moon, { size: "1.2rem" })
    }
  );
}
