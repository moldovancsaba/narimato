...
interface PublicProductCardMetaItem {
    label: string;
    value: ReactNode;
}
...
declare function PublicProductCard({ title, description, image, price, helperText, state, primaryAction, secondaryAction, metadata, compact, loading, disabled, }: PublicProductCardProps): react_jsx_runtime.JSX.Element;

type AccentTone = 'gray' | 'violet' | 'green' | 'red' | 'amber' | 'blue';
type AccentPanelVariant = 'subtle' | 'soft-outline';
...
declare function resolveAccentPanelStyles(tone?: AccentTone, variant?: AccentPanelVariant): {
...
declare function PublicNav({ items, activeId, renderLink }: PublicNavProps): react_jsx_runtime.JSX.Element;
...
declare function PublicShell({ brand, navItems, activeNavId, navigation, actions, footer, mobileNavigation, children, headerBordered, compact, maxContentWidth, }: PublicShellProps): react_jsx_runtime.JSX.Element;

interface PublicSiteFooterProps {
    children?: ReactNode;
    meta?: ReactNode;
}
declare function PublicSiteFooter({ children, meta }: PublicSiteFooterProps): react_jsx_runtime.JSX.Element;

interface PublicBrandFooterProps {
    media?: ReactNode;
...
declare function PublicBrandFooter({ media, brandTitle, description, actions, secondary, legal, compact, }: PublicBrandFooterProps): react_jsx_runtime.JSX.Element;
...
declare function CtaButtonGroup({ primary, secondary, tertiary }: CtaButtonGroupProps): react_jsx_runtime.JSX.Element;
...
declare function DocsPageShell({ breadcrumbs, title, lead, eyebrow, meta, sideRail, footerNext, children, }: DocsPageShellProps): react_jsx_runtime.JSX.Element;
...
declare function EditorialHero({ eyebrow, title, description, actions, meta, media, mediaAlt, mediaPosition, mediaFade, align, compact, loading, error, }: EditorialHeroProps): react_jsx_runtime.JSX.Element;
...
declare function FeatureBand({ items, columns, bordered, loading, emptyState, }: FeatureBandProps): react_jsx_runtime.JSX.Element;
...
declare function PlaceholderPanel({ title, description, badge, footer, children, mode, }: PlaceholderPanelProps): react_jsx_runtime.JSX.Element;

interface SimpleTableColumn<T extends Record<string, unknown>> {
    key: keyof T | string;
    header: string;
    render?: (row: T) => ReactNode;
}
interface SimpleDataTableProps<T extends Record<string, unknown>> {
...
declare function SimpleDataTable<T extends Record<string, unknown>>({ columns, rows, loading, error, emptyTitle, emptyDescription, getRowKey, }: SimpleDataTableProps<T>): react_jsx_runtime.JSX.Element;
...
type GdsLocale = keyof typeof gdsLocales;
declare function getGdsMessages(locale: GdsLocale | string): {
    'gds.action.settings': string;
    'gds.action.analytics': string;
    'gds.action.dashboard': string;
    'gds.action.play': string;
...
export { AccentPanel, type AccentPanelProps, type AccentPanelVariant, type AccentTone, AccessSummary, type AccessSummaryProps, ArticleShell, type ArticleShellProps, AuthShell, type AuthShellProps, type BreadcrumbItem, CtaButtonGroup, type CtaButtonGroupProps, DataToolbar, type DataToolbarFilterChip, type DataToolbarProps, DocsPageShell, type DocsPageShellProps, EditorialHero, type EditorialHeroAction, type EditorialHeroMetaItem, type EditorialHeroProps, EmptyState, type EmptyStateProps, FeatureBand, type FeatureBandItem, type FeatureBandProps, FilterDrawer, type FilterDrawerProps, FormField, type FormFieldProps, GdsIcons, type GdsLocale, GdsVocabulary, MediaCard, type MediaCardAction, type MediaCardProps, MetricCard, type MetricCardProps, PageHeader, type PageHeaderEyebrowVariant, type PageHeaderProps, PlaceholderPanel, type PlaceholderPanelProps, ProductCard, type ProductCardAction, type ProductCardMetaItem, type ProductCardProps, ProgressCard, type ProgressCardProps, PublicBrandFooter, type PublicBrandFooterProps, PublicNav, type PublicNavItem, type PublicNavProps, PublicProductCard, type PublicProductCardMetaItem, type PublicProductCardProps, type PublicProductCardState, PublicShell, type PublicShellProps, PublicSiteFooter, type PublicSiteFooterProps, type SemanticAction, SimpleDataTable, type SimpleDataTableProps, type SimpleTableColumn, StateBlock, type StateBlockProps, type StateBlockVariant, StatsSection, type StatsSectionProps, StatusBadge, type StatusBadgeProps, type StatusVariant, ar, de, en, es, fr, gdsLocales, getGdsMessages, he, hu, it, resolveAccentPanelStyles, ru };
