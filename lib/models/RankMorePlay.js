...
function registerRankMorePlayModel(connection) {
  return connection.models.RankMorePlay || connection.model('RankMorePlay', rankMorePlaySchema);
}

module.exports = createModelProxy('RankMorePlay', registerRankMorePlayModel, () =>
  legacyModel('RankMorePlay', rankMorePlaySchema)
);
module.exports.registerRankMorePlayModel = registerRankMorePlayModel;
