...
function registerPagePasswordModel(connection) {
  return connection.models.PagePassword || connection.model('PagePassword', pagePasswordSchema);
}

const PagePassword =
  mongoose.models.PagePassword || mongoose.model('PagePassword', pagePasswordSchema);

module.exports = PagePassword;
module.exports.registerPagePasswordModel = registerPagePasswordModel;
