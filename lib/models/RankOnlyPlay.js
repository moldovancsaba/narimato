...
function registerRankOnlyPlayModel(connection) {
  return connection.models.RankOnlyPlay || connection.model('RankOnlyPlay', rankOnlyPlaySchema);
}

module.exports = createModelProxy('RankOnlyPlay', registerRankOnlyPlayModel, () =>
  legacyModel('RankOnlyPlay', rankOnlyPlaySchema)
);
module.exports.registerRankOnlyPlayModel = registerRankOnlyPlayModel;
