...
function registerSwipeMorePlayModel(connection) {
  return connection.models.SwipeMorePlay || connection.model('SwipeMorePlay', swipeMorePlaySchema);
}

module.exports = createModelProxy('SwipeMorePlay', registerSwipeMorePlayModel, () =>
  legacyModel('SwipeMorePlay', swipeMorePlaySchema)
);
module.exports.registerSwipeMorePlayModel = registerSwipeMorePlayModel;
