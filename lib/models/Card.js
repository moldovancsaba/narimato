...
const cardSchema = new mongoose.Schema({
  ...
  source: {
    type: String,
    enum: ['manual', 'intelligence'],
    default: 'manual',
  },
  archivedAt: { type: Date, default: null },
  replacesCardId: { type: String, default: null },
  replacedByCardId: { type: String, default: null },
  generationJobId: { type: String, default: null },
  topicSpecId: { type: String, default: null },
  operatorFeedback: { type: String, default: null },
...
function registerCardModel(connection) {
  return connection.models.Card || connection.model('Card', cardSchema);
}

module.exports = createModelProxy('Card', registerCardModel, () => legacyModel('Card', cardSchema), {
  cardSchema,
  registerCardModel,
});
