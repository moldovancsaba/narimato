...
function registerVoteMorePlayModel(connection) {
  return connection.models.VoteMorePlay || connection.model('VoteMorePlay', voteMorePlaySchema);
}

module.exports = createModelProxy('VoteMorePlay', registerVoteMorePlayModel, () =>
  legacyModel('VoteMorePlay', voteMorePlaySchema)
);
module.exports.registerVoteMorePlayModel = registerVoteMorePlayModel;
